...
@interface GGCPUMonitorCore : NSObject
/**
 Mobile cpu usage calculation.
...
- (GGWatcherReport *)report {
    return [[GGWatcherReport alloc] initWithValue:@(GGCPUMonitorCore.cpuUsage).stringValue];
}
